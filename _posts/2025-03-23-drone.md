...
- DJI julkisti 360 asteen 8K-videota kuvaavan [Avata 360 -droonin](https://mobiili.fi/2026/03/26/dji-julkisti-360-asteen-8k-videota-kuvaavan-avata-360-droonin/)
- Ukrainan droonit lamauttivat Venäjän öljy­viennin Itä­merellä [HS](https://www.hs.fi/suomi/art-2000011909494.html)
- Tällainen on Suomeen harhautunut AN-196-lennokki [IL](https://www.is.fi/ulkomaat/art-2000011911289.html)
- Tutkimus­johtaja Hyppönen: Droonin kotimaan pystyy selvittämään käytännössä aina [HS](https://www.hs.fi/kirjeenvaihtajat/art-2000011911227.html)
- Mikko Hyppönen: Tekoäly ja puolustusteknologia [8.4.2026 TEK](https://www.tek.fi/fi/tapahtumat/mikko-hypponen-tekoaly-ja-puolustusteknologia)
...
- log out
  - profile: the same as register number;

## Avata 2 - operator number setup

- Do not use "Tunnusnumero" from Proof of co mpletion of the online training:
  - Dronessa tulee olla näkyvissä lennonharjoittajan tunnusnumero (operaattorin tunnus), joka on rekisteröitymisestä saatu numerosarja, eikä erillistä dronen "tunnusnumeroa"; tämä numerosarja todistaa dronen omistajan rekisteröityneen EASA:n vaatimusten mukaisesti. [Gemini 2.5]
  - "Dronen suora etätunnistejärjestelmä (Remote ID) lähettää reaaliaikaisesti tietoa dronesta ja lennättäjästä. Tätä varten järjestelmään tulee syöttää operaattoritunnus ja pin-koodi (Operator registration number, PIN-Code). Nämä löytyvät rekisteröitymisen yhteydessä saapuneesta vahvistussähköpostista, esim. FIN123456789012x-xxx. Lisäksi järjestelmään tulee mahdollisesti syöttää dronen sarjanumero." [droneinfo](https://www.droneinfo.fi/fi/usein-kysyttya-rekisteroitymisesta-ja-koulutuksista)
- [QR-generator](https://talonendm.github.io/ballrotation/qr-generator/index.html) and in [p5editor](https://editor.p5js.org/haques/sketches/7MFcdhJPu) and [Qreturn-form](https://docs.google.com/forms/d/1mz9UU1q2SS7rXGBkz41dvxPWyMpXgqD9wtL7YSs0FnA/edit)
  - [responses for ta.dm](https://docs.google.com/forms/d/1mz9UU1q2SS7rXGBkz41dvxPWyMpXgqD9wtL7YSs0FnA/edit#responses) (private)

# Kaupallinen ilmakuvaus

- [ilmakuvaajat.com](https://ilmakuvaajat.com/aloita-kaupallinen-drone-lennatys/)
- kuvauskopteri kelpaa metsän kalustoksi [maaseuduntulevaisuus, 2017](https://www.maaseuduntulevaisuus.fi/metsa/37553e7b-3c12-570c-bc2d-7aac0faa2a36) (DJI Neo, Hover X1)
