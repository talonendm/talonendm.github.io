...
## gh-pages APP setup 251109

- Example: [tabletti](https://talonendm.github.io/tabletti/)
- Create icons e.g. Gimp and create manifest.json as

~~~
{
  "name": "Keittiön tabletti",
  "short_name": "Tabletti",
