...
- The perfect starting place for your web app or personal project. [Free forever](https://vercel.com/pricing).

# VS code copilot tips

## 2024

- Posenet, see e.g. [p5js ML5 ](https://editor.p5js.org/kylemcdonald/sketches/H1OoUd9h7)
