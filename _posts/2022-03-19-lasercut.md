...
- [Kattorakenteita](https://editor.p5js.org/haques/sketches/Fhwx9zdYCd): vaakaruoteet, pystyruoteet, tuuletusrimat
  - cutted at Oodi. 
    - Open in CorelDraw. rescale. For some reason canvas **550*s, 550*s** was not exactly in square shape. Error about 0.1-1 percent. 
    - save as / Print
...
- p5-box. s = 2.83474164873, coefficent. 1mm, e.g. 283px if 100mm
