...
layout: post
title: C
subtitle: old games wake up from coma - part 3
tags:
  - c
  - antique code
comments: true
cover-img: /assets/pics/page/screenshot/worm_c_score.JPG
thumbnail-img: /assets/pics/page/screenshot/wormgame.JPG
published: true
---
# C - worm game

Surprise, one more worm game :D .. no need to check code, listen podcast about this topic at [https://talonendm.podbean.com/](https://talonendm.podbean.com/) and C worm episode at [c-worm](https://talonendm.podbean.com/e/c-worm/)


## Mount folder with oldgames
Start DOSBox, I have DOSBox 0.74-3. Create folder "OLDGAMES" to C-drive and copy yor files there. This was already discussed in [part 1 - Turbo Pascal](https://talonendm.github.io/2020-11-22-TurboPascal/).

~~~
Z:\> mount C C:\OLDGAMES\c_kaantaja\
Z:\> C:
C:\> WORM
~~~

The latest built is available here [WORM.exe](https://talonendm.github.io/assets/c/WORM.exe).
