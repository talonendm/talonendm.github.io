...
- Ezviz yhdistäminen onnistui, kun CISCO:sta Automatic Configguration DHCP päällä (ei static ip), utta default DHCP Server *Enabled* asetuksesta *Disabled* asetukseen. 251005
