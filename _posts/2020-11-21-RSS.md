...
<script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/0.7.2/addons/p5.dom.min.js"></script> // this probably needed if objects created in js
...
function draw() {
  ...
  for (const title of titles) {
	text(title, random(0, width/2,height);
  }
